...
// Pinos dos FSR Sensors (4 sensores) — corrigido para incluir D32 como FSR
const int fsrPins[4] = {32, 39, 34, 35};

// Pinos dos Flex Sensors (7 sensores) — removido D32 dos FLEX
const int flexPins[7] = {33, 25, 26, 27, 14, 12, 13};
...
void loop() {
  ...
  // Lê os valores dos Flex Sensors (7 sensores)
  for (int i = 0; i < 7; i++) {
